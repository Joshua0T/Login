            ...
            {isAuthenticated ? (
              <>
                <button
                  ...
                  className="relative px-4 py-2 font-semibold text-black bg-red-600 rounded-lg shadow-md group"
                >
                  Cerrar Sesión
                </button>
                <button
                  onClick={handleUsersClick} // Llama a la función para ir a la página de usuarios
                  className="relative px-4 py-2 font-semibold text-black bg-green-600 rounded-lg shadow-md group"
                >
                  Ver Usuarios
                </button>
              </>
